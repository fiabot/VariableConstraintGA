...
algorithm = Shuffling(problem_space, number_generations=150, population_size=200, max_memory=500, cross_over_rate=0.5, mutation_rate=0.05,user=user, update_interval=30)

print(algorithm.run()) 

print(algorithm.infeasible_pop)

print(algorithm.infeasible_pop[0][1].get_info())
